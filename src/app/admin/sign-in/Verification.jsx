...
const VerificationPage = ({setHeading,setRenderComponent}) => {
  ...
  <div className="flex flex-col items-centr ">
    ...
    <button
      className={`py-[12px] mb-[12px] mt-[40px] w-[500px] bg-[#03030c] font-bold text-lg rounded-[8px] hover:border-2  border-[#00D8ff] ${otp[otp.length-1]!="" ? 'text-white' : 'text-[#00d8ff] ' }  hover:text-[#00d8ff]  active:bg-[#00d8ff] active:text-black`} onClick={()=>setRenderComponent(3)}
    >
      Verify
    </button>
